    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-4">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-1">
              {stats?.totalCount?.toLocaleString() || 0} transactions
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {stats?.totalFees ? formatCurrency(parseFloat(stats.totalFees)) : '₦0'}
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {stats?.averageAmount ? formatCurrency(parseFloat(stats.averageAmount)) : '₦0'}
            </div>
          </CardContent>
        </Card>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>View and search all transactions</CardDescription>
        </CardHeader>
          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <Select value={typeFilter} onValueChange={setTypeFilter}>
              ...
              <SelectContent>
                ...
                <SelectItem value="VTU_AIRTIME">VTU Airtime</SelectItem>
                <SelectItem value="VTU_DATA">VTU Data</SelectItem>
                <SelectItem value="GIFTCARD_BUY">Gift Card Buy</SelectItem>
                <SelectItem value="GIFTCARD_SELL">Gift Card Sell</SelectItem>
