  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-3xl font-bold tracking-tight">Circle USDC</h2>
          <p className="text-muted-foreground">Manage Circle wallets, fees, and transactions</p>
        </div>
      ...
      <Tabs defaultValue="wallets" className="space-y-6">
        <TabsList className="grid w-full grid-cols-4">
          ...
          <TabsTrigger
            value="fees"
            className="gap-2"
            onClick={() => router.push('/dashboard/circle-wallets/fee-config')}
          >
          ...
          <TabsTrigger
            value="collection"
            className="gap-2"
            onClick={() => router.push('/dashboard/circle-wallets/fee-collection')}
          >
          ...
          <TabsTrigger
            value="retries"
            className="gap-2"
            onClick={() => router.push('/dashboard/circle-wallets/fee-retries')}
          >
              ...
              <div className="flex flex-col md:flex-row gap-4">
                ...
                <Select value={custodyFilter} onValueChange={setCustodyFilter}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="MODULAR">Modular (Gasless)</SelectItem>
                  </SelectContent>
                </Select>
              </div>
